            ...
            <div>
                <div className='grid grid-cols-1 md:grid-cols-2 text-center md:text-left'>
                    <div className='flex flex-col md:flex-row items-center'>
                        <img src={icon04} alt="icon-04" className='m-5'/>
                        <div>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        <img src={icon05} alt="icon-05" className='m-5'/>
                        <div>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        <img src={icon06} alt="icon-06" className='m-5'/>
                        <div>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        <img src={icon07} alt="icon-07" className='m-5'/>
                        <div>
